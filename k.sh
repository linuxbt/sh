...
linux_panel() {
	...
	echo -e "${lv}3. 1Panel新一代管理面板${bai}                 ${kjlan}4. NginxProxyManager可视化面板${bai}"
	echo -e "${lan}5. AList多存储文件列表程序${bai}              ${lv}6. Ubuntu远程桌面网页版${bai}"
	echo -e "${kjlan}7. 哪吒探针VPS监控面板${bai}                  ${lv}8. QB离线BT磁力下载面板${bai}"
	echo -e "${lan}9. Poste.io邮件服务器程序${bai}               ${kjlan}10. RocketChat多人在线聊天系统${bai}"
	echo -e "${hong}------------------------${bai}"
	echo -e "${lv}11. 禅道项目管理软件${bai}                    ${kjlan}12. 青龙面板定时任务管理平台${bai}"
	echo -e "${lan}13. Cloudreve网盘${bai}                       ${lv}14. 简单图床图片管理程序${bai}"
	echo -e "${kjlan}15. emby多媒体管理系统${bai}                  ${lan}16. Speedtest测速面板${bai}"
	echo -e "${lv}17. AdGuardHome去广告软件${bai}               ${hong}18. onlyoffice在线办公OFFICE${bai}"
	echo -e "${kjlan}19. 雷池WAF防火墙面板${bai}                   ${lan}20. portainer容器管理面板${bai}"
	echo -e "${hong}------------------------${bai}"
	echo -e "${lv}21. VScode网页版${bai}                        ${lan}22. UptimeKuma监控工具${bai}"
	echo -e "${kjlan}23. Memos网页备忘录${bai}                     ${lv}24. Webtop远程桌面网页版${bai}"
	echo -e "${lan}25. Nextcloud网盘${bai}                       ${kjlan}26. QD-Today定时任务管理框架${bai}"
	echo -e "${lv}27. Dockge容器堆栈管理面板${bai}              ${lan}28. LibreSpeed测速工具${bai}"
	echo -e "${kjlan}29. searxng聚合搜索站${bai}                   ${lv}30. PhotoPrism私有相册系统${bai}"
	echo -e "${hong}------------------------${bai}"
	echo -e "${lan}31. StirlingPDF工具大全${bai}                 ${kjlan}32. drawio免费的在线图表软件${bai}"
	echo -e "${lv}33. Sun-Panel导航面板${bai}                   ${kjlan}34. Pingvin-Share文件分享平台${bai}"
	echo -e "${lan}35. 极简朋友圈${bai}                          ${lv}36. LobeChatAI聊天聚合网站${bai}"
	echo -e "${kjlan}37. MyIP工具箱${bai}                          ${lan}38. 小雅alist全家桶${bai}"
	echo -e "${lv}39. Bililive直播录制工具${bai}                ${hong}40. docker版Windows 2022${bai}"
	echo -e "${hong}------------------------${bai}"
