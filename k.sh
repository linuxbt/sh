...
linux_panel() {
    ...
    while true; do
      ...
      echo "▶ 面板工具"
      echo -e "${hong}------------------------${bai}"
      echo -e "${hong}1. 宝塔面板官方版${bai}                       ${lan}2. aaPanel宝塔国际版${bai}"
      echo -e "${hong}3. 1Panel新一代管理面板${bai}                 ${lv}4. NginxProxyManager可视化面板${bai}"
      echo -e "${hong}5. AList多存储文件列表程序${bai}              ${lv}6. Ubuntu远程桌面网页版${bai}"
      echo -e "${hong}7. 哪吒探针VPS监控面板${bai}                  ${lv}8. QB离线BT磁力下载面板${bai}"
      echo -e "${hong}9. Poste.io邮件服务器程序${bai}               ${lv}10. RocketChat多人在线聊天系统${bai}"
      echo -e "${hong}------------------------${bai}"
      echo -e "${hong}11. 禅道项目管理软件${bai}                    ${lv}12. 青龙面板定时任务管理平台${bai}"
      echo -e "${hong}13. Cloudreve网盘${bai}                       ${lv}14. 简单图床图片管理程序${bai}"
      echo -e "${hong}15. emby多媒体管理系统${bai}                  ${lv}16. Speedtest测速面板${bai}"
      echo -e "${hong}17. AdGuardHome去广告软件${bai}               ${lv}18. onlyoffice在线办公OFFICE${bai}"
      echo -e "${hong}19. 雷池WAF防火墙面板${bai}                   ${lv}20. portainer容器管理面板${bai}"
      echo -e "${hong}------------------------${bai}"
      echo -e "${hong}21. VScode网页版${bai}                        ${lv}22. UptimeKuma监控工具${bai}"
      echo -e "${hong}23. Memos网页备忘录${bai}                     ${lv}24. Webtop远程桌面网页版${bai}"
      echo -e "${hong}25. Nextcloud网盘${bai}                       ${lv}26. QD-Today定时任务管理框架${bai}"
      echo -e "${hong}27. Dockge容器堆栈管理面板${bai}              ${lv}28. LibreSpeed测速工具${bai}"
      echo -e "${hong}29. searxng聚合搜索站${bai}                   ${lv}30. PhotoPrism私有相册系统${bai}"
      echo -e "${hong}------------------------${bai}"
      echo -e "${hong}31. StirlingPDF工具大全${bai}                 ${lv}32. drawio免费的在线图表软件${bai}"
      echo -e "${hong}33. Sun-Panel导航面板${bai}                   ${lv}34. Pingvin-Share文件分享平台${bai}"
      echo -e "${hong}35. 极简朋友圈${bai}                          ${lv}36. LobeChatAI聊天聚合网站${bai}"
      echo -e "${hong}37. MyIP工具箱${bai}                          ${lv}38. 小雅alist全家桶${bai}"
      echo -e "${hong}39. Bililive直播录制工具${bai}                ${lv}40. docker版Windows 2022${bai}"
      echo -e "${hong}------------------------${bai}"
      echo -e "${hong}51. PVE开小鸡面板${bai}"
      echo -e "${hong}------------------------${bai}"
      echo -e "${hong}0. 返回主菜单${bai}"
      echo -e "${hong}------------------------${bai}"
      read -p "请输入你的选择: " sub_choice
