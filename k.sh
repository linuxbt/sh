...
bip39_manage() {
    while true; do
	  ...
	  echo "apk add curl bash argon2 openssl xxd"
      echo "------------------------"
      echo "0. 返回主菜单"
      echo "q. 退出"      
      echo -e "------------------------${bai}"
      ...
      case $sub_choice in
	      ...
	      curl -O https://raw.githubusercontent.com/linuxbt/sh/refs/heads/main/sh/bip39_encry_ios_b.sh && bash bip39_encry_ios_b.sh
