...
bip39_manage() {
    while true; do
      ...
      echo "苹果 iSH 软件中 -- curl 和 bash 安装命令如下: "
      echo "apk add curl bash"
      echo "------------------------"
      echo "0. 返回主菜单"
      echo -e "------------------------${bai}"
      read -p "请输入你的选择: " sub_choice
      ...
      case $sub_choice in
          ...
          2)
              ...
              bash <(curl -sSL https://raw.githubusercontent.com/linuxbt/sh/refs/heads/main/sh/bip39_encry_ios.sh)
