...
echo "============================"
echo "本项目原hysteria2地址："
echo "https://github.com/apernet/hysteria"
echo "必须客户端支持hysteria2才行，否则就是你安装了也无法使用。"
echo "============================"
...
echo "安卓端："
echo "----------------------------"
echo "nekobox (neko支持端口跳跃,优先推荐)："
echo "https://github.com/MatsuriDayo/NekoBoxForAndroid"
echo "----------------------------"
echo "clash-mate："
echo "https://github.com/MetaCubeX/ClashMetaForAndroid"
echo "----------------------------"
echo "hiddify (国外大神制作)："
echo "https://github.com/hiddify/hiddify-next"
echo "----------------------------"
...
echo "----------------------------"
echo "nekoray："
echo "https://github.com/MatsuriDayo/nekoray"
echo "----------------------------"
echo "clash-verge："
echo "https://github.com/zzzgydi/clash-verge"
echo "----------------------------"
echo "hiddify (国外大神制作)："
echo "https://github.com/hiddify/hiddify-next"
echo "----------------------------"
